...
//описываем то что мы имеем ввиду под этой датой
public class LocalDateTimeCoercing implements Coercing<LocalDateTime, String> { //<> означает что мы будем парсить LocalDateTime из Стринга
    @Override
